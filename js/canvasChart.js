var CanvasChart = function () {
	...
	var renderText = function() {
		var labelFont = (data.labelFont != null) ? data.labelFont : '20pt Times New Roman';
		ctx.font = labelFont;
	...
	var renderLinesAndLabels = function () {
		...
		for (var i = 0; i < data.dataPoints.length; i++) {
			...
			//y axis labels
			ctx.font = (data.dataPointFont != null) ? data.dataPointFont : '10pt Times New Roman';
